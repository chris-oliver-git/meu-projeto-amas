...
import { MapPin, Clock, Phone, ArrowUpRight, ChevronRight } from 'lucide-react';
...
export default function AmasParceirosPage({ setPaginaAtiva }) {
  return (
    <div className="bg-[#f4f6f9] pb-12">
      ...
      {/* BANNER REORGANIZADO PARA MOBILE */}
      ...
      {/* LISTAGEM DE CARDS RESTRUTURADOS COM FOCO MOBILE */}
        ...
        <div className="space-y-6">
          {REDE_CREDENCIADA.map((parceiro) => (
            <div key={parceiro.id} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
              ...
              {/* ESPECIALIDADES OFERECIDAS (Otimizado para não quebrar em telemóveis finos) */}
              <div className="px-4 sm:px-6 pb-4">
                <div className="bg-[#f8fafc] border border-gray-100 rounded-xl p-4 sm:p-5 space-y-3">
                  ...
                  {/* Grid Fluida: 1 coluna em telemóveis muito pequenos, escalando até 4 */}
